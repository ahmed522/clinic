...
class SetClinicGovernorateWidget extends StatelessWidget {
  const SetClinicGovernorateWidget({
    Key? key,
    required this.index,
    required this.mode,
  }) : super(key: key);
                    ...
                    ? GetBuilder<SignupController>(
                        ...
                        builder: (controller) {
                          return AppDropdownButton(
                            ...
                            onChanged: (item) => controller
                                .updateClinicGovernorate(item!, index),
                    ...
                    : GetBuilder<SingleClinicController>(
                        builder: (controller) {
                          return AppDropdownButton(
                            items: Regions.governorates,
                            onChanged: (item) =>
                                controller.updateClinicGovernorate(item!),
                            value: controller.tempClinic.governorate,
                          );
                        },
                      ),
              ),
